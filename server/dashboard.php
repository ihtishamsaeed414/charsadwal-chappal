        ...
        <div class="layout">
         ...
         <section class="main-section">
           ...
           <?php
            ...
            mysqli_query($connect,"UPDATE category SET cat_name = '$categoryname' WHERE cat_id = '".$_GET['id']."'");
...
<form method="post" class="form-cat">
...
<table border="2" class="table">
    <th>ID</th><th>Category Name</th><th>Status</th><th>Delete</th><th>Update</th>
    <?php
        while($row = mysqli_fetch_assoc($result)){
            ...
            echo "<a href='addcategories.php?type=edit&id=".$row['cat_id']."'>Update</a></td></tr>";
        }
    ?>
       </table>
     </section>
